-- Create kids_meal_plans table for Kids School Meal Planner
...
CREATE POLICY IF NOT EXISTS "Users can view kids meal plans they have access to"
...
CREATE POLICY IF NOT EXISTS "Users can insert kids meal plans for their family kids"
ON public.kids_meal_plans
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY IF NOT EXISTS "Users can update their own kids meal plans"
ON public.kids_meal_plans
FOR UPDATE
TO authenticated
...
CREATE POLICY IF NOT EXISTS "Users can delete their own kids meal plans"
ON public.kids_meal_plans
FOR DELETE
TO authenticated
USING (created_by = auth.uid());
